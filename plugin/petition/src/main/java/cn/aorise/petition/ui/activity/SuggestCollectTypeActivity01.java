...
public class SuggestCollectTypeActivity01 extends PetitionBaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_suggest_collect_JYLXE),data.get(position).getMC());
                editor.putString(getString(R.string.petition_suggest_collect_JYLXEDM),data.get(position).getDM().toString());
                editor.commit();
                Intent intent=new Intent(SuggestCollectTypeActivity01.this,SuggestCollectTypeActivity02.class);
