...
public class RegistAddressActivity extends PetitionBaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                editor.commit();
                Intent intent=new Intent(RegistAddressActivity.this,RegistAddressActivity01.class);
