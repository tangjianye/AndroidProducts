...
public class RequestAddQuestActivity01 extends PetitionBaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_sharepre_LXE),data.get(position).getMC());
                editor.putString(getString(R.string.petition_shareprefer_LXEDM),data.get(position).getDM().toString());
                editor.commit();
                Intent intent=new Intent(RequestAddQuestActivity01.this,RequestAddQuestActivity02.class);
