    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_sharepre_SFD_SH),data.get(position).getMC());
                editor.putString(getString(R.string.petition_sharepre_SFD_SHDM),data.get(position).getDM().toString());
                editor.commit();
