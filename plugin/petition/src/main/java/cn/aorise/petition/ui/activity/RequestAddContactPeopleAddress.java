...
public class RequestAddContactPeopleAddress extends PetitionBaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_shareprefers_contact_people_SH),data.get(position).getMC());
                editor.commit();
                Intent intent=new Intent(RequestAddContactPeopleAddress.this,RequestAddContactPeopleAddress01.class);
