...
public class SuggestCollectTypeActivity extends PetitionBaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_suggest_collect_JYLXY),data.get(position).getMC());
                editor.putString(getString(R.string.petition_suggest_collect_JYLXYDM),data.get(position).getDM().toString());
                editor.commit();
                Intent intent=new Intent(SuggestCollectTypeActivity.this,SuggestCollectTypeActivity01.class);
