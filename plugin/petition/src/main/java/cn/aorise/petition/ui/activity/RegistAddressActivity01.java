...
public class RegistAddressActivity01 extends PetitionBaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                editor.commit();
                Intent intent=new Intent(RegistAddressActivity01.this,RegistAddressActivity02.class);
