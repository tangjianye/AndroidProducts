...
public class RequestAddressChooseActivity01 extends PetitionBaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_sharepre_SFD_S),data.get(position).getMC());
                editor.putString(getString(R.string.petition_sharepre_SFD_SDM),data.get(position).getDM().toString());
                editor.commit();
                Intent intent=new Intent(RequestAddressChooseActivity01.this,RequestAddressChooseActivity02.class);
