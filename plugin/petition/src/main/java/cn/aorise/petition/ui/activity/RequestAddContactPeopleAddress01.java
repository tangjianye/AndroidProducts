...
public class RequestAddContactPeopleAddress01 extends PetitionBaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_shareprefers_contact_people_S),data.get(position).getMC());
                editor.commit();
                Intent intent=new Intent(RequestAddContactPeopleAddress01.this,RequestAddContactPeopleAddress02.class);
